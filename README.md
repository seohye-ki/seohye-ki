...
- **삼성 청년 SW•AI 아카데미** *(2024.07 ~ 2025.06)*  
  - 알고리즘 및 코딩 집중 교육을 통해 문제 해결력의 기초를 다지고, Java·Spring·React·MySQL 기반의 실무형 프로젝트와 AI 활용 개발을 통해 SW 개발 및 협업 역량을 강화하였습니다.
- **42서울** *(2023.08 ~ 2024.06)*  
  - C/C++ 언어 기반 알고리즘·시스템 프로그래밍, Git 협업·코드리뷰, 팀 과제 등을 수행하며 문제 해결력과 실무형 협업 역량을 강화하였습니다.
